...
export function LectureDetailModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleModalOpenChange}>
      <DialogContent
        className="flex max-h-[90vh] w-[calc(100vw-24px)] max-w-[800px] flex-col overflow-hidden rounded-[32px] border-0 bg-white p-0 shadow-[0_0_14px_rgba(138,138,138,0.16)]"
        showClose={false}
      >
        <LectureDetailHeader
          isEditing={isEditing}
            ...
            <div className="px-6 py-5 sm:px-10 sm:py-6">
              <LectureDetailEditForm
                ...
                onStatusChange={(value) =>
                  setEditStatus(value as LectureStatus)
                }
